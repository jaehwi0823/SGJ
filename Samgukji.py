...
encoding_dict = {}
cnter = 0
for c in seoul.text.fillna(''):
    if c not in encoding_dict:
        encoding_dict[c] = cnter
        cnter += 1
# encoding
